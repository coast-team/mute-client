...
var SIGNALING_SERVER = 'ws://localhost:8000';
...
var PeerIOAdapter = function(coordinator){
  ...
  this.webChannel = new nf.WebChannel({signaling: SIGNALING_SERVER}); //the main object of Netflux.js which replaces this.peer
