...
SCAMP.prototype.makeOffer = function(){
    ...
    var msg = JSON.stringify(new Message(this.replicaNumber, this.clock, 'offer', data, this.peer.id));
    ...
    function sendMsg(remoteId){
        var connection = this.peer.connect(remoteId);
...
SCAMP.prototype.acceptOffer = function(msg){
    ...
    if(remoteConnection !== null  && remoteConnection !== undefined){
        ...
        remotePeerInfo.connection = remoteConnection;
        this.peers.push(remotePeerInfo);
        this.remoteConnection.send(peerInfo, 'accept', msg.data.connection);
...
SCAMP.prototype.broadcastMsg = function(){
    //TODO
}
